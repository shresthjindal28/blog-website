  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-[40%] -left-[30%] w-[80%] h-[80%] rounded-full opacity-30 blur-3xl bg-gradient-to-r from-purple-600 to-pink-500 animate-pulse-slow"></div>
        <div className="absolute -bottom-[30%] -right-[30%] w-[75%] h-[75%] rounded-full opacity-30 blur-3xl bg-gradient-to-r from-blue-500 to-teal-400 animate-pulse-slower"></div>
      </div>
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link 
                to="/forgot-password" 
                className={`font-medium transition-colors ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'}`}
              >
          ...
          <div className="text-center">
            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <Link to="/register" className={`font-medium transition-colors ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'}`}>
                Sign up
              </Link>
            </p>
          </div>
